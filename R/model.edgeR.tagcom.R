...
#' 
#' @usage
#' model.edgeR.tagcom(counts, x, lib.sizes=colSums(counts), prior.df = prior.df, design=design)
#' 
...
#' 
model.edgeR.tagcom = function(counts, x, lib.sizes=colSums(counts), prior.df = prior.df, design = design){
