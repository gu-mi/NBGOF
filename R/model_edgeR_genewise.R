...
#' @title Modeling NB genewise model with the adjusted profile likelihood estimator 
#' (APLE) on original and simulated datasets
#' 
...
#' \code{\link{eglmFit}} functions in the \code{\link{edgeR}} package
...
#' 
#' @return An object called "model_gen_m_obj" to be passed to the main
