...
## -------------------------------------------------------------------------
## Estiamte the regression coefficients in an NB2 GLM model: irls.nb.1
## -------------------------------------------------------------------------
...
## -------------------------------------------------------------------------
## Estiamte the regression coefficients in an NBP GLM model: irls.nbp.1
## -------------------------------------------------------------------------
irls.nbp.1 <- function(y, s, x, phi0, alpha1, beta0=rep(NA, p),
  ...
  # returned mu, beta, phi ---> will be used in apl.phi.alpha.1()
}
